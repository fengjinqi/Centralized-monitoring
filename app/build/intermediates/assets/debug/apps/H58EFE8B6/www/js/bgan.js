...
function showMap(){
    ...
    mui.ajax('http://127.0.0.1:10330/cmonitor/servlet/InsertBganServlet',{
         data:{"jd":String(_lng),"wd":String(_lat),"orgname":document.getElementById('orgname').value,"fzr":document.getElementById('fzr').value,"telephone":document.getElementById('telephone').value},
         dataType:'text',
         type:'post',//HTTP请求类型
         success:function(data){
...
function tijiao(n){
    ...
    mui.ajax('http://127.0.0.1:10330/cmonitor/servlet/UpdateBganServlet',{
         data:obj,
         dataType:'text',
         type:'post',//HTTP请求类型
         success:function(data){
...
function removeOne(n){
    ...
    mui.ajax('http://127.0.0.1:10330/cmonitor/servlet/DelBganServlet',{
...
function markerClick(e,n) {
   var el=e
   var btnArray = ['否', '是'];
    mui.confirm('是否创建BGAN信息?', '', btnArray, function(e) {
        if (e.index == 1) {
